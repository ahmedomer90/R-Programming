...
#Update a newer version of DMRCate
...
MB_expression_data <- fread("/home/ahmed/Ncl-PhD/GSE85217_M_exp_763_MB_SubtypeStudy_TaylorLab.txt")

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000172901" & MB_expression_data$HGNC_symbol_from_ensemblv77 == ""] <- "LVRN"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000143674" & MB_expression_data$HGNC_symbol_from_ensemblv77 == ""] <- "MAP3K21"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000186960" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "C14orf23"] <- "LINC01551"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000168004" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "HRASLS5"] <- "PLAAT5"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000275126" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "HIST1H4L"] <- "H4C13"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000135390" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "ATP5G2"] <- "ATP5MC2"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000182183" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "FAM159A"] <- "SHISAL2A"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000105219" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "CNTD2"] <- "CCNP"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000197558" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "SSPO"] <- "SSPOP"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000246705" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "H2AFJ"] <- "H2AJ"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000162069" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "CCDC64B"] <- "BICDL2"

# Copy the RDS file I dropped off for you into your working directory
MB_methylation_data <- readRDS("/home/ahmed/Ncl-PhD/Mset.GM.RDS")

# Annotation data
annot <- read.csv("/home/ahmed/Ncl-PhD/Taylor_Pheno_forDan.csv")
...
## Create subdirectory 
subDir <- paste(sep="_", names(table(labels))[2],names(table(labels))[1],Sys.Date()) 
dir.create(subDir) 
...
library(rtracklayer) 
cpgi <- import.bed("/home/eds/Nordlund-Backlin-2013/cpgi.bed") 
...
{ 
  ...
  results[[i]] <- maxDiffFinder(i, gord.GM2 = class.GM, dmr.gr2 = dmr.gr3, labels="SHH_4") 
} 
...
{ 
  ...
  if(length(toTest) == 0) { cat(paste0("No Exp for Gene ", yfg,"\n"))} else { 
    ...
    { 
      ...
      par(cex.axis=1) 
      par(cex.axis=0.6) 
      axis(1, cex=0.1, labels = levels(factor(MB_expression_data_class)), at=1:13, las=2) 
