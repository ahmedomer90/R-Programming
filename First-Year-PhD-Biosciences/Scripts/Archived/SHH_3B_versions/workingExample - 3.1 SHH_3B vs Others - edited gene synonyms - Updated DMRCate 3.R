...
MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000163689" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "C3orf67"] <- "CFAP20DC"
...
{ 
  ...
  results[[i]] <- maxDiffFinder(i, gord.GM2 = class.GM, dmr.gr2 = dmr.gr3, labels="SHH_3B") 
} 
