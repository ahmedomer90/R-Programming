...
MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000135390" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "FAM109B"] <- "PHETA2"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000135390" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "C11orf85"] <- "MAJIN"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000135390" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "ELTD1"] <- "ADGRL4"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000135390" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "C17orf62"] <- "CYBC1"

MB_expression_data$HGNC_symbol_from_ensemblv77[MB_expression_data$EnsemblGeneID_from_ensemblv77 == "ENSG00000135390" & MB_expression_data$HGNC_symbol_from_ensemblv77 == "SUV420H2"] <- "KMT5C"
