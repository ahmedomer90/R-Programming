...
# M-values are generated only for the selected SHH_3B-versus-Other samples below.
...
labels <- ifelse(labels == "SHH_3B", "SHH_3B", "Other")
table(labels)
...
# With this ordering, coefficient 2 in the design matrix is SHH_3B versus Other.
class.grp <- factor(
  labels[keep],
...
## Because levels(class.grp) is c(class2, class1), coef = 2 tests SHH_3B versus Other.
design <- model.matrix(~ class.grp)

stopifnot(
  ncol(design) == 2L,
  identical(levels(class.grp), c("Other", "SHH_3B"))
)
