...
Identification of Copy Number Alteration (CNA) Heterogeneity in Cancer
...
The primary aim is to create a reproducible, well-documented R workflow that demonstrates the complete analytical process used in the dissertation.

## Objectives

- Reconstruct the original analysis workflow
